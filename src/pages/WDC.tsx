...
const WDC: FC = () => {
    ...
    return (
        <Layout>
            <div className="bg-gradient-to-t from-[#23313F] via-[#311D38] to-[#2C2E56] -z-10 absolute top-0 h-screen w-screen">
                <motion.div
                ...
                >
                        ...
                        <div className="flex flex-col justify-center items-center">
                            <div className="flex gap-8 justify-center items-center">
                                ...
                                <div className="flex flex-col">
                                    <div className="font-retroica text-6xl pl-[1rem] pb-[0.5rem] text-transparent bg-clip-text bg-gradient-to-r from-[#CDF9FF] to-[#F1D2FF]">Web</div>
                                    <div className="font-retroica text-6xl pl-[1rem] pb-[0.5rem] text-transparent bg-clip-text bg-gradient-to-r from-[#F1D2FF] to-[#FFE5C6]">Design</div>
                                    <div className="font-retroica text-6xl pl-[1rem] pb-[0.5rem] text-transparent bg-clip-text bg-gradient-to-r from-[#CDF9FF] to-[#FFE5C6]">Competition</div>
                    ...
                    <div className="lg:hidden flex flex-col justify-center items-center h-screen w-screen px-4">
                        ...
                        <div className="text-center">
                            ...
                            <div className="font-retroica text-2xl text-white pb-[1rem] px-4">Web Design Competition</div>
                        </div>
                ...
                <div ref={contentRef} className="bg-gradient-to-b from-[#23313F] via-[#311D38] to-[#2C2E56]">
                    <div className="flex flex-col items-center gap-2 pt-4 pl-4 pr-4">
                        ...
                        <div className="py-12 flex flex-col lg:flex-row justify-center gap-8">
                            <div className="w-screen lg:w-[40%] px-4">
                                <Card className="!bg-[#2C2E56] !border-gray-700">
                                    <h3 className="font-retroica text-[#E99CCE] text-2xl pl-6">Ketentuan Umum</h3>
                            ...
                            <div className="w-screen lg:w-[40%] px-4">
                                <Card className="!bg-[#2C2E56] !border-gray-700">
                                    <h3 className="font-retroica text-[#E99CCE] text-2xl pl-6">Ketentuan Karya</h3>
                                    <div className="text-white leading-loose font-louisgeorgecafe p-6">
                                        <ol className="list-outside list-decimal">
                                            <li>
                        ...
                        <div className="flex flex-col justify-center lg:items-center w-full lg:w-[70%]">
                            <div className="font-retroica text-[#E99CCE] text-4xl mb-8 mx-auto text-center">Timeline</div>
                            <div className="rounded-xl bg-[#241f3d] pb-1 w-fit">
                                <div className="rounded-xl font-retroica bg-[#311D38] p-4 text-white shadow-inner">Tahap Eliminasi</div>
                            </div>
                            ...
                            <div className="rounded-xl bg-[#241f3d] pb-1 w-fit">
                                <div className="rounded-xl font-retroica bg-[#716B90] p-4 text-white shadow-inner">Tahap Final</div>
                            </div>
                        ...
                        <div className="pt-8 flex flex-col gap-4 justify-center items-center w-screen">
                            ...
                            <div className="font-retroica text-[#ffba57] text-center"> <span className="font-louisgeorgecafe text-white">Total hadiah</span> Rp6.000.000</div>
                            <div>
                                <div className="hidden lg:flex flex-row gap-8 pt-10">
                                    <Card className="bg-[#311D38] !border-gray-700 text-white hover:scale-110 hover:bg-[#9e9e9e] hover:text-[#311D38] transition ease-in duration-300 w-[30%]">
                                        <div className="">
                                            <img className="w-52 block m-auto" src="https://ifest.uajy.ac.id/assets/images/medal-1.png" alt="/" />
                                        </div>
                                    ...
                                    <Card className="bg-[#311D38] !border-gray-700 text-white hover:scale-110 hover:bg-[#ce7430] hover:text-[#311D38] transition ease-in duration-300 w-[30%]">
                                        <div className="">
                                    ...
                                    <Card className="bg-[#311D38] !border-gray-700 text-white hover:scale-110 hover:bg-[#00B8B0] hover:text-[#311D38] transition ease-in duration-300 w-[30%]">
                                        <div className="">
                                            <img className="w-52 block m-auto" src="https://ifest.uajy.ac.id/assets/images/medal-3.png" alt="/" />
                                        </div>
                                        <div className="font-retroica text-center text-2xl">Juara II</div>
                                        <div className="font-retroica flex gap-3"><FaMoneyBillWave /> Rp1.000.000</div>
                                        <div className="font-retroica flex gap-3"><FaCertificate /> Sertifikat Nasional</div>
                                    </Card>
                                </div>
                                <div className="flex lg:hidden flex-col gap-8">
                                    <Card horizontal className="bg-[#311D38] !border-gray-700 text-white hover:scale-110 hover:bg-[#ffba57] hover:text-[#311D38] transition ease-in duration-300">
                                    ...
                                    <Card horizontal className="bg-[#241f3d] !border-gray-700 text-white hover:scale-110 hover:bg-[#00B8B0] hover:text-[#241f3d] transition ease-in duration-300">
                                        <div className="flex gap-4">
                                            <div>
                                                <div className="font-retroica text-right text-2xl">Juara III</div>
                                                <div className="font-retroica flex gap-3"><FaMoneyBillWave /> Rp1.000.000</div>
                                                <div className="font-retroica flex gap-3"><FaCertificate /> Sertifikat Nasional</div>
                                            </div>
                                            <div>
                        ...
                        <div className="flex flex-col justify-center items-center w-screen my-12">
                            <div className="bg-gradient-to-l from-[#23313F] via-[#311D38] to-[#2C2E56] border-gray-200 max-w-[100%] w-[21rem] lg:w-[60%] rounded-xl p-8">
                                <div className="flex flex-col lg:flex-row text-center justify-center items-center lg:justify-start">
                                    ...
                                    <div className="flex flex-col gap-4  items-center lg:items-start">
                                        <div className="font-retroica text-2xl lg:text-3xl text-[#E99CCE]">Tertarik? Ayo mendaftar!</div>
