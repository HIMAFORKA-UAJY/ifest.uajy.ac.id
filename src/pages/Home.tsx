      ...
      <Layout>
        <div className="bg-[url('/images/bg-no-flip.png')] bg-center bg-cover bg-no-repeat -z-10 absolute top-0 h-screen w-screen">
          ...
          <motion.div className="flex flex-col justify-center items-center h-screen">
            ...
            />
            <TypeAnimation
              sequence={[2000, "Technology Rebuild Our Country"]}
              speed={45}
              wrapper="h2"
              cursor={false}
            ...
            <motion.button
              onClick={() =>
                i2cRef.current?.scrollIntoView({ behavior: "smooth" })
              }
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
                ...
                <div className="flex flex-col">
                  ...
                  <div className="p-4 font-retroica text-white w-[32em]">
                    <p className="text-justify">
                      <strong>Innovative Informatics Contest</strong> (I2C) 2022
                      adalah sebuah kompetisi ide kreatif untuk merancang
                      aplikasi yang inovatif secara berkelompok beranggotakan 3
                      orang. I2C 2022 ini mengusung tema "A Journey To Better
                      Home Living".
                    </p>
                  </div>
            ...
            <div className="lg:hidden flex flex-col justify-center items-center h-screen w-screen">
              ...
              <div className="p-4 font-retroica text-white">
                <p className="text-justify">
                  <strong>Innovative Informatics Contest</strong> (I2C) 2022
                  adalah sebuah kompetisi ide kreatif untuk merancang aplikasi
                  yang inovatif secara berkelompok beranggotakan 3 orang. I2C
                  2022 ini mengusung tema "A Journey To Better Home Living".
                </p>
              </div>
              <div>
                <motion.button
                    ...
                    return (
                      <SwiperSlide className="w-[19rem] h-[31rem]">
                        <div className="text-center flex gap-2 flex-col h-full items-center justify-center bg-[#352A7C]">
                          ...
                          <div className="font-retroica text-[#ffffff]">
                            {publication.author}
                          </div>
                          ...
                          <button className="font-retroica text-[#9C8DFC] pt-4">
                            Find out more
                          </button>
                        </div>
                      </SwiperSlide>
