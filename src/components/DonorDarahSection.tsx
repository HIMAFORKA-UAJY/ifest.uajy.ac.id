...
const DonorDarahSection: FC = () => {
  return (
    ...
    >
      <div className="hidden w-screen flex-col items-center justify-center lg:flex pb-24 pt-24">
        <div className="flex items-center justify-center">
          ...
          <div className="flex flex-col">
            <div className="pl-[1rem] font-retroica text-4xl tracking-wide text-white pb-4">Donor Darah</div>
            ...
            <div className="w-[32em] p-4 font-louisgeorgecafe text-white">
              <p className="text-justify">
                <strong>Donor darah </strong> adalah suatu aksi kebaikan yang dilakukan dengan cara menyumbangkan sebagian darah kepada orang lain yang membutuhkan.
            ...
            <div className="pl-[1rem]">
              <motion.button
                ...
                className="mt-7 rounded-[2.0em] bg-[#ff7676] bg-gradient-to-br from-[#fd9807] px-5 py-3 font-retroica text-sm text-white lg:text-base transition-all hover:scale-105 hover:shadow-[0_0px_80px_0px_#fd9807]"
              >
